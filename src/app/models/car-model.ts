export interface CarModel {
    id: number;
    carName: string;        // Map từ cột 'car_name'
    carType: string;        // Map từ cột 'car_type'
    active: boolean;        // Map từ cột 'active'
    maintenanceCycle?: number; // Field tùy chọn (nếu backend chưa trả về thì không lỗi)
}
